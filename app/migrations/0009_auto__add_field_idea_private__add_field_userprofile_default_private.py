...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Idea.private'
        db.add_column('app_idea', 'private', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserProfile.default_private'
        db.add_column('app_userprofile', 'default_private', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Idea.private'
        db.delete_column('app_idea', 'private')

        # Deleting field 'UserProfile.default_private'
        db.delete_column('app_userprofile', 'default_private')
