...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Idea.started'
        db.add_column('app_idea', 'started', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Idea.started'
        db.delete_column('app_idea', 'started')
