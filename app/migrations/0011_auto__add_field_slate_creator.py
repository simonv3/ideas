...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Slate.creator'
        db.add_column('app_slate', 'creator', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='slate_creator', blank=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Slate.creator'
        db.delete_column('app_slate', 'creator_id')
    ...
    models = {
        ...
        'app.slate': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'slate_creator'", 'blank': 'True', 'to': "orm['auth.User']"}),
