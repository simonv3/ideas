...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Idea.elaborate'
        db.delete_column('app_idea', 'elaborate')


    def backwards(self, orm):
        
        # Adding field 'Idea.elaborate'
        db.add_column('app_idea', 'elaborate', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
