...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.facebook_access_token'
        db.add_column('app_userprofile', 'facebook_access_token', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.facebook_access_token'
        db.delete_column('app_userprofile', 'facebook_access_token')
